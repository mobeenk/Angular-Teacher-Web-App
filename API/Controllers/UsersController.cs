...
namespace API.Controllers
{
    ...
    public async Task<ActionResult<ChangePasswordDto>> ChangePassword(ChangePasswordDto changePassword)
    {
       ...
       if (await _unitOfWork.Complete())
        ...
        return new ChangePasswordDto
        {
            ...
            // PasswordO = changePassword.PasswordO,
            // PasswordN = changePassword.PasswordN
